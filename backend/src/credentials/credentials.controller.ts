...
import { SetCredentialsResponseDto, SetCredentialsRequestDto, CredentialsDto} from './dto';
...
export class CredentialsController {
    ...
    @Post()
    async setCredentials(@Body() credentials: SetCredentialsRequestDto): Promise<SetCredentialsResponseDto> {
